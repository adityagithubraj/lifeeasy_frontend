...
import { Car, Smartphone, Factory, Cloud, Zap, Shield, Cpu, Globe } from 'lucide-react';
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-lg bg-gradient-to-br ${feature.color} flex items-center justify-center shadow-lg`}>
